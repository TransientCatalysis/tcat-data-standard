...
```python
from tcat_data import validate_dataset, ManifestEntry
...
| `src/tcat_data/schema/0.1.0/` | The schemas. Six document kinds plus shared definitions. Versions live in their own directories and are **never removed**. |
| `src/tcat_data/` | The validator, the manifest indirection, checksums, and the normative artifact-hash rule. |
