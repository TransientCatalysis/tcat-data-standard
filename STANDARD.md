...
**Standards version:** 0.8.0 — what this document says. Moves only on a normative change, and that needs written approval (`COLLABORATION.md` section 5). Read it from `tcat_data.STANDARDS_VERSION`.
...
**Schema version:** 0.5.0 (`src/tcat_data/schema/0.5.0/`; `0.4.0/`, `0.3.0/`, `0.2.0/` and `0.1.0/` are frozen and retained)
