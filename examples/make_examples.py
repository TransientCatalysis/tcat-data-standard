...
def build_dataset(entry: ManifestEntry, protocol: dict, cal_id: str) -> dict:
    ...
    return {
        ...
        "maturity": {
            ...
            "notes": "Synthetic. Generated by examples/make_examples.py to exercise the schema end to end, and not a measurement of anything. Nothing downstream should treat it as data.",
        },
...
def build_sample() -> dict:
    ...
    the numbers are invented. It exists so that the join -- a fitted rate
    ...
    return {
        ...
        "properties": {
            ...
            "reducibility_T_max": {
                ...
                "notes": "The kind of property a fitted rate constant gets correlated against.",
            },
            "v_surface_density": {
    ...
    return {
        ...
        "metrics": {
            "steady_state_rate_rel_error": {
                ...
                "notes": "SYNTHETIC. This study's target for held-out prediction is <= 15%.",
            },
            "trace_nrmse": {
        ...
        "identifiability": {
            ...
            "notes": (
                ...
                "direction here, which is the normal situation and the reason an "
        ...
        "license": "CC-BY-4.0",
        "project": "genesis-prbs-phase-1",
        "objective": {"label": "1b-mechanism", "milestone": "identifiable-constants"},
...
def build_model_spec_axial_psu() -> dict:
    ...
    This is the reproduction comparator. The requirement reads "reproduce the published PSU
    ...
    return {
        ...
        "license": "CC-BY-4.0",
        "notes": (
            "DRAFT (2026-08), axial-PDE branch. The reproduction comparator: same free "
...
def build_model_spec_axial_thermo() -> dict:
    ...
    spec["notes"] = (
        "DRAFT (2026-08), axial-PDE branch. The physical constants an "
        "identifiability claim asks for, fitted under the reactor model the "
        "published comparison is stated against."
    )
    return spec
...
def build_model_spec_thermo() -> dict:
    ...
    return {
        ...
        "access_status": "public",
        "license": "CC-BY-4.0",
        "notes": "The physical constants this project is ultimately after "
...
def build_spoke() -> dict:
    """A spoke manifest, which is the one document a new spoke must write.

    It is here rather than only in the template because a template is copied and
    then edited, whereas an example is regenerated and therefore cannot drift
    away from the schema. This is the shape `tcat-validate spoke` checks.
    """
    return {
        "standard_version": CURRENT_SCHEMA_VERSION,
        "spoke_id": "example-prbs-lab",
        "kind": "data",
        "name": "Example PRBS reactor spoke",
        ...
        "stewards": [
            {
                ...
                "credit_roles": ["data-curation", "software"],
            },
            {
                "name": "Example Instrument Owner",
                "institution": "Example University",
                "role": "instrument_owner",
                "github": "example-instrument-owner",
                "orcid": "0000-0002-1825-0098",
                "credit_roles": ["investigation", "validation"],
                "since": "2026-01-01",
            },
        ],
        "maturity": {
            "rung": "sandbox",
            "notes": (
                "The default for records here that make no claim of their own. "
                "A spoke may not claim higher than working, because the rungs "
                "above rest on facts about a particular record."
            ),
        },
        "layout": {
            "dataset": ["manifests", "canonical", "raw", "derived"],
        ...
        "exclude": ["scratch"],
        "strict": False,
        "notes": "A worked example of the manifest, regenerated by make_examples.py.",
    }
